...
const MeshEditor = ({
    ...
    return (
        <div className='flex items-center bg-gray-100 border-b border-gray-300 px-4'>

            <div
                className='ml-4 rounded my-2 px-4  py-2 flex items-center hover:bg-blue-100 hover:border-blue-500 border-2'>
