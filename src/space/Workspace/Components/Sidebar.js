  ...
  return (
    <div class='flex flex-col items-center w-24 h-screen overflow-hidden text-indigo-300 bg-indigo-900 rounded'>
      <div class='flex flex-col items-center mt-3 border-t border-gray-700'>
        ...
        <div class='flex flex-col items-center justify-center w-full h-full mt-3 p-3 rounded-lg hover:bg-indigo-700' onClick={handleAnimationsClick}>
          <svg
            class='w-10 h-10'
            viewBox='0 0 24 24'
            xmlns='http://www.w3.org/2000/svg'
          ...
          <span class='text-base font-semibold leading-6'>Animations</span>
        </div>
      </div>
    </div>
  )
